...
if (recid === "undefined") {
	...
	$.getJSON(recurl, function(data){
    	...
    	var html ='${data.hits.hits[0].metadata.citation_count}'
    	}  
...
<i class="ai ai-inspire ai-fw"></i> inspire: <a href="https://inspirehep.net/literature/2148186" target="_blank" rel="noopener"> 2148186 </a> (<div id="inspirecount"></div> citations)
<br/>
